...
image::../plugins/ql/org.gemoc.ql.model/model/ql/img/ql main class diagram.jpg[FCL main class diagram,800]
...
image::../plugins/ql/org.gemoc.ql.model/model/img/Expression class diagram.jpg[Expression class diagram,800]

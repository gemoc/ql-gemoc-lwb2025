...
public class Activator extends AbstractUIPlugin {
    // The plug-in ID
    public static final String PLUGIN_ID = "org.gemoc.ql.design";
    ...
    public void start(BundleContext context) throws Exception {
	  ...
	  viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(PLUGIN_ID + "/description/ql.odesign")); 
    }

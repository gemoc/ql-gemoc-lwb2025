 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.ql.model.ql.impl.UnaryExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	protected EClass eStaticClass() {
		return QlPackage.Literals.UNARY_EXPRESSION;
	}
	...
	public NotificationChain basicSetOperand(Expression newOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					QlPackage.UNARY_EXPRESSION__OPERAND, oldOperand, newOperand);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject) operand).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QlPackage.UNARY_EXPRESSION__OPERAND, null, msgs);
			if (newOperand != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QlPackage.UNARY_EXPRESSION__OPERAND, newOperand,
					newOperand));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enumeration Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.ql.model.ql.impl.EnumerationCallImpl#getEnumerationLiteral <em>Enumeration Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationCallImpl extends CallImpl implements EnumerationCall {
	...
	protected EClass eStaticClass() {
		return QlPackage.Literals.ENUMERATION_CALL;
	}
			...
			if (enumerationLiteral != oldEnumerationLiteral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							QlPackage.ENUMERATION_CALL__ENUMERATION_LITERAL, oldEnumerationLiteral,
							enumerationLiteral));
			}
		}
	...
	public void setEnumerationLiteral(EnumerationLiteral newEnumerationLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QlPackage.ENUMERATION_CALL__ENUMERATION_LITERAL,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case QlPackage.ENUMERATION_CALL__ENUMERATION_LITERAL:
			if (resolve)

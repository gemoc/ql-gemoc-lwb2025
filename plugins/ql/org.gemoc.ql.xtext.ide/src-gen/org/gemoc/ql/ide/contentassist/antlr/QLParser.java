...
public class QLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, QLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEFloatAccess().getAlternatives_3_0(), "rule__EFloat__Alternatives_3_0");
			...
			builder.put(grammarAccess.getEFloatAccess().getGroup_3(), "rule__EFloat__Group_3__0");

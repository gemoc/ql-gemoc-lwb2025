...
public class QLModelAspect {
  ...
  protected static void _privk3_initializeModel(final QLModelAspectQLModelAspectProperties _self_, final QLModel _self, final EList<String> input) {
    ...
    final Function1<DefinitionGroup, EList<QuestionDefinition>> _function = new Function1<DefinitionGroup, EList<QuestionDefinition>>() {
      public EList<QuestionDefinition> apply(final DefinitionGroup f) {
        return f.getQuestionDefinitions();
      }
    };
    final Consumer<QuestionDefinition> _function_1 = new Consumer<QuestionDefinition>() {
    ...
    while ((_self.getSubmitDate() == null)) {
      {
        ...
        final Function1<DefinitionGroup, EList<QuestionDefinition>> _function = new Function1<DefinitionGroup, EList<QuestionDefinition>>() {
          public EList<QuestionDefinition> apply(final DefinitionGroup f_1) {
            return f_1.getQuestionDefinitions();
          }
        };
        final Function1<QuestionDefinition, Boolean> _function_1 = new Function1<QuestionDefinition, Boolean>() {
          public Boolean apply(final QuestionDefinition qd) {
            return Boolean.valueOf(qd.isIsDisplayed());
          }
        };
        final Function1<QuestionDefinition, Boolean> _function_2 = new Function1<QuestionDefinition, Boolean>() {
          public Boolean apply(final QuestionDefinition qd) {
        ...
        _self.setCanSubmit((IterableExtensions.isEmpty(allDisplayedMandatory) || IterableExtensions.<QuestionDefinition>forall(allDisplayedMandatory, new Function1<QuestionDefinition, Boolean>() {
          public Boolean apply(final QuestionDefinition qd) {
        ...
        final Function1<DefinitionGroup, EList<QuestionDefinition>> _function_3 = new Function1<DefinitionGroup, EList<QuestionDefinition>>() {
          public EList<QuestionDefinition> apply(final DefinitionGroup f_1) {
            return f_1.getQuestionDefinitions();
          }
        };
        final Function1<QuestionDefinition, Boolean> _function_4 = new Function1<QuestionDefinition, Boolean>() {
          public Boolean apply(final QuestionDefinition qd) {
            return Boolean.valueOf(qd.isIsDisplayed());
          }
        };
        ...
        final Consumer<QuestionDefinition> _function_5 = new Consumer<QuestionDefinition>() {
          public void accept(final QuestionDefinition qd) {
  ...
  protected static void _privk3_updateAllComputedQuestions(final QLModelAspectQLModelAspectProperties _self_, final QLModel _self) {
    ...
    final Function1<QuestionDefinition, String> _function = new Function1<QuestionDefinition, String>() {
      public String apply(final QuestionDefinition qd) {
        return qd.getName();
      }
    };
    ...
    final Consumer<QuestionDefinition> _function_1 = new Consumer<QuestionDefinition>() {
      public void accept(final QuestionDefinition qd) {
        try {
          ...
          final Iterator<QuestionCall> notDisplayedDependencies = IteratorExtensions.<QuestionCall>filter(Iterators.<QuestionCall>filter(qd.getComputedExpression().eAllContents(), QuestionCall.class), _function);
          ...
          if (_not) {
            ...
            String _plus_1 = (_plus + " depends on question(s) ");
            final Function1<QuestionCall, String> _function_1 = new Function1<QuestionCall, String>() {
              public String apply(final QuestionCall qdc) {
                return qdc.getQuestion().getName();
              }
            };
            String _join = IteratorExtensions.join(IteratorExtensions.<QuestionCall, String>map(notDisplayedDependencies, _function_1), ", ");
            String _plus_2 = (_plus_1 + _join);
            String _plus_3 = (_plus_2 + " that are currently not displayed ");
            throw new QLException(_plus_3);
          } else {
  ...
  protected static List<QuestionDefinition> _privk3_sortAllDisplayedComputedQuestions(final QLModelAspectQLModelAspectProperties _self_, final QLModel _self) {
    try {
      ...
      final Function1<QuestionDefinition, String> _function_2 = new Function1<QuestionDefinition, String>() {
        public String apply(final QuestionDefinition qd) {
          return qd.getName();
        }
      };
      ...
      EObjectAspect.devDebug(_self, _plus);
      final Consumer<QuestionDefinition> _function_3 = new Consumer<QuestionDefinition>() {
        public void accept(final QuestionDefinition qd) {
          QuestionDefinitionAspect.evaluateComputedQuestionDependencies(qd);
        }
      };
      ...
      while ((!nodeWithNoIncomingEdgeSet.isEmpty())) {
        {
          ...
          resList.add(n);
          final Consumer<QuestionDefinition> _function_5 = new Consumer<QuestionDefinition>() {
            public void accept(final QuestionDefinition m) {
      ...
      final Function1<QuestionDefinition, Boolean> _function_5 = new Function1<QuestionDefinition, Boolean>() {
        public Boolean apply(final QuestionDefinition qd) {
      ...
      if (_exists) {
        ...
        final Function1<QuestionDefinition, Boolean> _function_6 = new Function1<QuestionDefinition, Boolean>() {
          public Boolean apply(final QuestionDefinition qd) {
            boolean _isEmpty = QuestionDefinitionAspect.dependencies(qd).isEmpty();
            return Boolean.valueOf((!_isEmpty));
          }
        };
        final Function1<QuestionDefinition, String> _function_7 = new Function1<QuestionDefinition, String>() {
          public String apply(final QuestionDefinition qd) {
            String _name = qd.getName();
            String _plus = (_name + " -> (");
            final Function1<QuestionDefinition, String> _function = new Function1<QuestionDefinition, String>() {
              public String apply(final QuestionDefinition qddep) {
                return qddep.getName();
              }
            };
            String _join = IterableExtensions.join(IterableExtensions.<QuestionDefinition, String>map(QuestionDefinitionAspect.dependencies(qd), _function), ", ");

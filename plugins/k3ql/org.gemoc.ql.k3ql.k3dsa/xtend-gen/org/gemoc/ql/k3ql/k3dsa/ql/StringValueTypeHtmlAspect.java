...
public class StringValueTypeHtmlAspect extends ValueTypeHtmlAspect {
  public static String htmlField(final StringValueType _self, final String id, final String label) {
    ...
    if (_self instanceof org.gemoc.ql.model.ql.StringValueType){
    	result = org.gemoc.ql.k3ql.k3dsa.ql.StringValueTypeHtmlAspect._privk3_htmlField(_self_, (org.gemoc.ql.model.ql.StringValueType)_self,id,label);
    };
    return (java.lang.String)result;
  }

  protected static String _privk3_htmlField(final StringValueTypeHtmlAspectStringValueTypeAspectProperties _self_, final StringValueType _self, final String id, final String label) {
    ...
    _builder.append(id, "\t\t      ");
    _builder.append("\" oninput=\"onUserChange(this)\">");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t    ");
    _builder.append("</div>");

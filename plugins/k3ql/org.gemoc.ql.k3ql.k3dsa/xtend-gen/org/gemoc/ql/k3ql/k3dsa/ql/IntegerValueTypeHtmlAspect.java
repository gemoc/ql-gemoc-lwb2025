...
public class IntegerValueTypeHtmlAspect extends ValueTypeHtmlAspect {
  public static String htmlField(final IntegerValueType _self, final String id, final String label) {
    ...
    if (_self instanceof org.gemoc.ql.model.ql.IntegerValueType){
    	result = org.gemoc.ql.k3ql.k3dsa.ql.IntegerValueTypeHtmlAspect._privk3_htmlField(_self_, (org.gemoc.ql.model.ql.IntegerValueType)_self,id,label);
    };
    return (java.lang.String)result;
  }

  protected static String _privk3_htmlField(final IntegerValueTypeHtmlAspectIntegerValueTypeAspectProperties _self_, final IntegerValueType _self, final String id, final String label) {

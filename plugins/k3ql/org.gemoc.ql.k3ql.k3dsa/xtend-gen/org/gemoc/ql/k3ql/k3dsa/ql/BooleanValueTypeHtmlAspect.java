...
public class BooleanValueTypeHtmlAspect extends ValueTypeHtmlAspect {
  public static String htmlField(final BooleanValueType _self, final String id, final String label) {
    ...
    if (_self instanceof org.gemoc.ql.model.ql.BooleanValueType){
    	result = org.gemoc.ql.k3ql.k3dsa.ql.BooleanValueTypeHtmlAspect._privk3_htmlField(_self_, (org.gemoc.ql.model.ql.BooleanValueType)_self,id,label);
    };
    return (java.lang.String)result;
  }

  protected static String _privk3_htmlField(final BooleanValueTypeHtmlAspectBooleanValueTypeAspectProperties _self_, final BooleanValueType _self, final String id, final String label) {
    ...
    _builder.append(id, "\t\t      ");
    _builder.append("\" value=\"false\" onchange=\"onUserChange(this)\">");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t    ");
    _builder.append("</div>");

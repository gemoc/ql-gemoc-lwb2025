...
public class DateValueTypeHtmlAspect extends ValueTypeHtmlAspect {
  public static String htmlField(final DateValueType _self, final String id, final String label) {
    ...
    if (_self instanceof org.gemoc.ql.model.ql.DateValueType){
    	result = org.gemoc.ql.k3ql.k3dsa.ql.DateValueTypeHtmlAspect._privk3_htmlField(_self_, (org.gemoc.ql.model.ql.DateValueType)_self,id,label);
    };
    return (java.lang.String)result;
  }

  protected static String _privk3_htmlField(final DateValueTypeHtmlAspectDateValueTypeAspectProperties _self_, final DateValueType _self, final String id, final String label) {

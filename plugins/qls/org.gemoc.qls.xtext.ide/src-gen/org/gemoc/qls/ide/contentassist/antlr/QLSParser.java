...
public class QLSParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, QLSGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getQLSModelAccess().getGroup_4(), "rule__QLSModel__Group_4__0");
			builder.put(grammarAccess.getQLSModelAccess().getGroup_4_3(), "rule__QLSModel__Group_4_3__0");
			builder.put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
			builder.put(grammarAccess.getQuestionStyleAccess().getGroup(), "rule__QuestionStyle__Group__0");
			builder.put(grammarAccess.getQuestionStyleAccess().getGroup_2(), "rule__QuestionStyle__Group_2__0");
			...
			builder.put(grammarAccess.getQLSModelAccess().getQuestionStylesAssignment_4_2(), "rule__QLSModel__QuestionStylesAssignment_4_2");
			builder.put(grammarAccess.getQLSModelAccess().getQuestionStylesAssignment_4_3_1(), "rule__QLSModel__QuestionStylesAssignment_4_3_1");
			...
			builder.put(grammarAccess.getQuestionStyleAccess().getLabelStyleAssignment_2_1(), "rule__QuestionStyle__LabelStyleAssignment_2_1");
			builder.put(grammarAccess.getQuestionStyleAccess().getTypeStyleAssignment_3_1(), "rule__QuestionStyle__TypeStyleAssignment_3_1");
			...
			builder.put(grammarAccess.getTextTypeStyleAccess().getMultilineAssignment_1(), "rule__TextTypeStyle__MultilineAssignment_1");

...
public class QlsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case QlsPackage.NUMERIC_TEXT_FIELD_STYLE: {
			NumericTextFieldStyle numericTextFieldStyle = (NumericTextFieldStyle) theEObject;
			T result = caseNumericTextFieldStyle(numericTextFieldStyle);
			if (result == null)
				result = caseNumericTypeStyle(numericTextFieldStyle);
			if (result == null)
				result = caseTypeStyle(numericTextFieldStyle);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Numeric Text Field Style</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Numeric Text Field Style</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNumericTextFieldStyle(NumericTextFieldStyle object) {
		return null;
	}

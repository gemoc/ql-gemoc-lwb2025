...
public class QlsAdapterFactory extends AdapterFactoryImpl {
	...
	protected QlsSwitch<Adapter> modelSwitch = new QlsSwitch<Adapter>() {
		...
		@Override
		public Adapter caseNumericTextFieldStyle(NumericTextFieldStyle object) {
			return createNumericTextFieldStyleAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gemoc.qls.model.qls.NumericTextFieldStyle <em>Numeric Text Field Style</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

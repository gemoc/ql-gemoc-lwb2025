...
public class QuestionStyleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addLabelStylePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_QuestionStyle_labelStyle_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_QuestionStyle_labelStyle_feature",
								"_UI_QuestionStyle_type"),
						QlsPackage.Literals.QUESTION_STYLE__LABEL_STYLE, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(QlsPackage.Literals.QUESTION_STYLE__TYPE_STYLE,
				QlsFactory.eINSTANCE.createNumericTextFieldStyle()));

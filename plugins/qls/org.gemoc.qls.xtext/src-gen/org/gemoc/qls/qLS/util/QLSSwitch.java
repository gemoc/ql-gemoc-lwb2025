  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case QLSPackage.NUMERIC_TYPE_STYLE:
      {
        ...
        if (result == null) result = caseTypeStyle(numericTypeStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case QLSPackage.BOOLEAN_TYPE_STYLE:
      {
        ...
        if (result == null) result = caseTypeStyle(booleanTypeStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case QLSPackage.NUMERIC_TYPE_TEXT_FIELD_STYLE:
      {
        ...
        if (result == null) result = caseNumericTypeStyle(numericTypeTextFieldStyle);
        if (result == null) result = caseTypeStyle(numericTypeTextFieldStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case QLSPackage.NUMERIC_TYPE_SPINNER_STYLE:
      {
        ...
        if (result == null) result = caseNumericTypeStyle(numericTypeSpinnerStyle);
        if (result == null) result = caseTypeStyle(numericTypeSpinnerStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case QLSPackage.TEXT_TYPE_STYLE:
      {
        ...
        if (result == null) result = caseTypeStyle(textTypeStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case QLSPackage.NUMERIC_SPINNER_STYLE:
      {
        ...
        if (result == null) result = caseNumericTypeSpinnerStyle(numericSpinnerStyle);
        if (result == null) result = caseNumericTypeStyle(numericSpinnerStyle);
        if (result == null) result = caseTypeStyle(numericSpinnerStyle);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }

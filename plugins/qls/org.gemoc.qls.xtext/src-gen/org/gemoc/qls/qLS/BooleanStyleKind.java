 ...
 * <!-- end-user-doc -->
 * @see org.gemoc.qls.qLS.QLSPackage#getBooleanStyleKind()
 * @model
 * @generated
 */
public enum BooleanStyleKind implements Enumerator
{
   ...
   * @generated
   */
  private static final BooleanStyleKind[] VALUES_ARRAY =
    new BooleanStyleKind[]
    {
      CHECKBOX,
      TWO_RADIO,
      DROPDOWN,
  ...
  public static BooleanStyleKind get(int value)
  {
    switch (value)
    {
      ...
      case TWO_RADIO_VALUE: return TWO_RADIO;

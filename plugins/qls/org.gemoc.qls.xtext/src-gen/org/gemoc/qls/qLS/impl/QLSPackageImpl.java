...
import org.gemoc.qls.qLS.QLSFactory;
...
public class QLSPackageImpl extends EPackageImpl implements QLSPackage
{
   ...
   * @see org.gemoc.qls.qLS.QLSPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  {
    if (isInited) return (QLSPackage)EPackage.Registry.INSTANCE.getEPackage(QLSPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredQLSPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    QLSPackageImpl theQLSPackage = registeredQLSPackage instanceof QLSPackageImpl ? (QLSPackageImpl)registeredQLSPackage : new QLSPackageImpl();
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(qlsModelEClass, QLSModel.class, "QLSModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getQLSModel_Imports(), this.getImport(), null, "imports", null, 0, -1, QLSModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getQLSModel_QuestionStyles(), this.getQuestionStyle(), null, "questionStyles", null, 0, -1, QLSModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(importEClass, Import.class, "Import", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getImport_ImportURI(), ecorePackage.getEString(), "importURI", null, 0, 1, Import.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(typeStyleEClass, TypeStyle.class, "TypeStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(numericTypeStyleEClass, NumericTypeStyle.class, "NumericTypeStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(questionStyleEClass, QuestionStyle.class, "QuestionStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getQuestionStyle_StyledQuestion(), theQlPackage.getQuestionDefinition(), null, "styledQuestion", null, 0, 1, QuestionStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getQuestionStyle_LabelStyle(), this.getLabelStyle(), null, "labelStyle", null, 0, 1, QuestionStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getQuestionStyle_TypeStyle(), this.getTypeStyle(), null, "typeStyle", null, 0, 1, QuestionStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(labelStyleEClass, LabelStyle.class, "LabelStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLabelStyle_Italic(), ecorePackage.getEBoolean(), "italic", null, 0, 1, LabelStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLabelStyle_Bold(), ecorePackage.getEBoolean(), "bold", null, 0, 1, LabelStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(booleanTypeStyleEClass, BooleanTypeStyle.class, "BooleanTypeStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getBooleanTypeStyle_BooleanStyleKind(), this.getBooleanStyleKind(), "booleanStyleKind", null, 0, 1, BooleanTypeStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numericTypeTextFieldStyleEClass, NumericTypeTextFieldStyle.class, "NumericTypeTextFieldStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNumericTypeTextFieldStyle_Step(), ecorePackage.getEDouble(), "step", null, 0, 1, NumericTypeTextFieldStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numericTypeSpinnerStyleEClass, NumericTypeSpinnerStyle.class, "NumericTypeSpinnerStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(textTypeStyleEClass, TextTypeStyle.class, "TextTypeStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTextTypeStyle_Multiline(), ecorePackage.getEBoolean(), "multiline", null, 0, 1, TextTypeStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numericSpinnerStyleEClass, NumericSpinnerStyle.class, "NumericSpinnerStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

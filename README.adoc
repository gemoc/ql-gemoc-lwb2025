...
BCOoL (Behavioral Coordination Operator Language) enables the specification of coordination patterns between different domain-specific modeling languages (DSMLs). It facilitates:

- The explicit definition of coordination operators.
- Automated coordination of heterogeneous models.
- Execution of coordinated models using an integrated engine.

An example application is the synchronization of timed finite state machines (TFSMs), as demonstrated in the BCOoL tutorial: https://gemoc.org/BCOoL/

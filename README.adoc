...
Command used to obtain SLOC: `cloc plugins --exclude-dir=xtend-gen,src-gen --exclude-ext=g,g4` from the root of the repository
====
...
| XML (e.g., Sirius, metamodels, project configurations) | 65 | 6,228
| Xtend (semantic implementation) | 8 | 2,332
| Java (custom add-ons, helpers) | 145 | 1,205
| Properties and Config | 46 | 334
| JavaScript (UI extensions) | 2 | 191
| Maven (pom.xml files) | 4 | 142
| Other (INI, text, SVG) | 7 | 37

...
- activating trace/timeline options (which are actually more relevant when starting the launch configuration in debug mode.)
====
...
* customized the formatting support.
* implemented the type checking of expressions.
...
| XML (e.g., Sirius models, workflows, configurations) | 44 | 4,976
| Xtend (behavioral semantics) | 7 | 1,486
| Java (engine addons, utilities) | 26 | 848
| Properties (config files) | 14 | 231
| Maven (build configuration) | 4 | 142
| JavaScript (UI customization) | 1 | 97
| INI and other small formats | 4 | 23

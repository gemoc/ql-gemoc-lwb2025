...
A `QLSModel` decorates a `QLModel`. It specifies sections that contains ordered content (other sub-sections or references to `QuestionDefinition`). These information are to organise the order and grouping of questions on the view. The actual visibility of a question remains a responsability of the QL model.
